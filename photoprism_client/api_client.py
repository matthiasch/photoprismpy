...
from photoprism_client.api_response import ApiResponse, T as ApiResponseT
import photoprism_client.models
from photoprism_client import rest
from photoprism_client.exceptions import (
    ApiValueError,
    ApiException,
    BadRequestException,
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(photoprism_client.models, klass)
