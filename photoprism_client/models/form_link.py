...
class FormLink(BaseModel):
    ...
    FormLink
    """ # noqa: E501
    can_comment: Optional[StrictBool] = Field(default=None, alias="CanComment")
    ...
    __properties: ClassVar[List[str]] = ["CanComment", "CanEdit", "Expires", "MaxViews", "Password", "Slug", "Token"]
