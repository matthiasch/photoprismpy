...
class EnvResources(BaseModel):
    ...
    memory: Optional[EnvResourcesMemory] = None
    routines: Optional[StrictInt] = None
    __properties: ClassVar[List[str]] = ["cores", "memory", "routines"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "cores": obj.get("cores"),
            "memory": EnvResourcesMemory.from_dict(obj["memory"]) if obj.get("memory") is not None else None,
