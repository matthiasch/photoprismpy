...
class FormSelection(BaseModel):
    """
    FormSelection
    """ # noqa: E501
    albums: Optional[List[StrictStr]] = None
    all: Optional[StrictBool] = None
    files: Optional[List[StrictStr]] = None
    labels: Optional[List[StrictStr]] = None
    photos: Optional[List[StrictStr]] = None
    places: Optional[List[StrictStr]] = None
    subjects: Optional[List[StrictStr]] = None
    __properties: ClassVar[List[str]] = ["albums", "all", "files", "labels", "photos", "places", "subjects"]
