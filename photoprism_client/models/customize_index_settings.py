...
class CustomizeIndexSettings(BaseModel):
    """
    CustomizeIndexSettings
    """ # noqa: E501
    convert: Optional[StrictBool] = None
    path: Optional[StrictStr] = None
    rescan: Optional[StrictBool] = None
    skip_archived: Optional[StrictBool] = Field(default=None, alias="skipArchived")
    __properties: ClassVar[List[str]] = ["convert", "path", "rescan", "skipArchived"]
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            ...
            "skipArchived": obj.get("skipArchived")
        })
        return _obj
