...
class FormDetails(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Artist", "ArtistSrc", "Copyright", "CopyrightSrc", "Keywords", "KeywordsSrc", "License", "LicenseSrc", "Notes", "NotesSrc", "PhotoID", "Subject", "SubjectSrc"]
