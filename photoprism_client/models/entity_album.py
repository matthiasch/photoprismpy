...
class EntityAlbum(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Caption", "Category", "Country", "CreatedAt", "CreatedBy", "Day", "DeletedAt", "Description", "Favorite", "Filter", "ID", "Location", "Month", "Notes", "Order", "ParentUID", "Path", "Private", "PublishedAt", "Slug", "State", "Template", "Thumb", "ThumbSrc", "Title", "Type", "UID", "UpdatedAt", "Year"]
