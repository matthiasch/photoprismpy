...
class SearchSubject(BaseModel):
    ...
    marker_src: Optional[StrictStr] = Field(default=None, alias="MarkerSrc")
    ...
    __properties: ClassVar[List[str]] = ["Alias", "Excluded", "Favorite", "FileCount", "Hidden", "MarkerSrc", "MarkerUID", "Name", "PhotoCount", "Private", "Slug", "Thumb", "ThumbSrc", "Type", "UID"]
