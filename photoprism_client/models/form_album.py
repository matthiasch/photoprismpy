...
class FormAlbum(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["Caption", "Category", "Country", "Description", "Favorite", "Filter", "Location", "Notes", "Order", "Private", "Template", "Thumb", "ThumbSrc", "Title", "Type"]
