...
class TestFormFile(unittest.TestCase):
    """FormFile unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormFile:
        """Test FormFile
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormFile`
        """
        model = FormFile()
        if include_optional:
            return FormFile(
