...
class TestFormLink(unittest.TestCase):
    """FormLink unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormLink:
        """Test FormLink
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormLink`
        """
        model = FormLink()
        if include_optional:
            return FormLink(
