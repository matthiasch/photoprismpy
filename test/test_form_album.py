...
class TestFormAlbum(unittest.TestCase):
    """FormAlbum unit test stubs"""
    ...
    def make_instance(self, include_optional) -> FormAlbum:
        """Test FormAlbum
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `FormAlbum`
        """
        model = FormAlbum()
        if include_optional:
            return FormAlbum(
