...
class TestSearchLabel(unittest.TestCase):
    """SearchLabel unit test stubs"""
    ...
    def make_instance(self, include_optional) -> SearchLabel:
        """Test SearchLabel
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `SearchLabel`
        """
        model = SearchLabel()
        if include_optional:
            return SearchLabel(
