...
class TestEntityPhoto(unittest.TestCase):
    """EntityPhoto unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityPhoto:
        """Test EntityPhoto
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityPhoto`
        """
        model = EntityPhoto()
        if include_optional:
            return EntityPhoto(
