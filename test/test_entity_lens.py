...
class TestEntityLens(unittest.TestCase):
    """EntityLens unit test stubs"""
    ...
    def make_instance(self, include_optional) -> EntityLens:
        """Test EntityLens
            include_optional is a boolean, when False only required
            params are included, when True both required and
            optional params are included """
        # uncomment below to create an instance of `EntityLens`
        """
        model = EntityLens()
        if include_optional:
            return EntityLens(
